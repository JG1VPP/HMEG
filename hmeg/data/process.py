...
class LG2Graph(object):
    ...
    def parse_lg(self, lg_path):
        ...
        rel_csv.iloc[:, 3] = rel_csv.iloc[:, 3].apply(
            lambda x: self.edge_types[norm_rel_tag(x)]
        )
    ...
    def to_graph(self, obj_csv, rel_csv):
        ...
        return {"node_types": node_types, "edge_types": edge_types, "edges": edges}
